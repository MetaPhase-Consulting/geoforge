      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start space-y-6 md:space-y-0">
          <div className="space-y-2">
            ...
            <p className="text-charcoal/70 dark:text-silver font-work-sans text-sm max-w-xs">Generative Optimization for LLM Discovery</p>
          </div>
          ...
          <div className="text-right space-y-2">
            <div className="flex items-center space-x-4 text-charcoal/70 dark:text-silver font-work-sans text-sm">
              <div className="flex items-center space-x-2">
                ...
                <a href="https://github.com/MetaPhase-Consulting/geoforge" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors">
                  Open Source
                </a>
              </div>
            ...
            <div className="text-charcoal/70 dark:text-silver font-work-sans text-sm">© {year} GEOforge</div>
          </div>
        </div>
      </div>
    </footer>
